...
app.post('/pay-without-webhooks', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, paymentMethodId, paymentIntentId, items, amount, currency, useStripeSdk, cvcToken, email, orderAmount, secret_key, stripe, customers, paymentMethods, params, intent, params, intent, intent, e_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, paymentMethodId = _a.paymentMethodId, paymentIntentId = _a.paymentIntentId, items = _a.items, amount = _a.amount, currency = _a.currency, useStripeSdk = _a.useStripeSdk, cvcToken = _a.cvcToken, email = _a.email;
                orderAmount = amount;
                secret_key = getKeys().secret_key;
                stripe = new stripe_1.default(secret_key, {
                    apiVersion: '2022-08-01',
            ...
            case 1:
                ...
                console.log("hit here: ".concat(orderAmount));
